...
public class ReceptionistHomePage extends JFrame implements ActionListener {
    ...
    public ReceptionistHomePage(String receptionistname, String receptionist_id, int login_id, String username) {
        super("Receptionist Home Page");
        setLocation(0, 0);
        setSize(1500, 730);
        this.receptionist_id2 = receptionist_id;
        ...
        contentPane = new JPanel() {
            protected void paintComponent(Graphics g) {
                ...
                ImageIcon ic = new ImageIcon(ClassLoader.getSystemResource("Hospital/Icons/res.jpg"));
    ...
    //public static void main(String[] args) {
        //new ReceptionistHomePage("John Doe", "123", 1).setVisible(true);
    //}
}
