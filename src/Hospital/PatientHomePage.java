...
public class PatientHomePage extends JFrame implements ActionListener {
    ...
    public PatientHomePage(String patientname, String patient_id, int login_id,String username) {
        super("patient Home Page");
        setLocation(0, 0);
        setSize(1500, 730);
        this.patient_id2 = patient_id;
        this.login__id = login_id;
        username2=username;

        contentPane = new JPanel() {
            protected void paintComponent(Graphics g) {
                super.paintComponent(g);
                ImageIcon ic = new ImageIcon(ClassLoader.getSystemResource("Hospital/Icons/pat2.jpg"));
        ...
        //JMenuItem ment5 = new JMenuItem("Add Patient");
        ...
        JMenuItem ment9 = new JMenuItem("Add Appointment");

        JMenu men5 = new JMenu("Hi, Receptionist (" + patientname + ")");
        JMenuItem ment10 = new JMenuItem("My Profile");
        JMenuItem ment11 = new JMenuItem("Change Password");
...
//        ment5.addActionListener(this);
   ...
   // public static void main(String[] args) {
       // new PatientHomePage("John Doe", "123", 1).setVisible(true);
    //}
}
